...
const skills = [
	...
	{ name: "CSS", icon: <FaCss3Alt />, color: "#2862E9", level: 85, text: "Flexbox, Grid, animaciones, responsive" },
	{ name: "Vite", icon: <SiVite />, color: "#A56DFF", level: 80, text: "Configuración, optimización y bundling rápido" },
	{ name: "Framer Motion", icon: <SiFramer />, color: "#E8E8E8", level: 70, text: "Animaciones fluidas y transiciones avanzadas" },
	{ name: "Git", icon: <FaGitAlt />, color: "#F05033", level: 85, text: "Branching, commits, merges y flujo profesional" },
	{ name: "GitHub", icon: <SiGithub />, color: "#E8E8E8", level: 90, text: "Repos, issues, documentación y versiones" },
];

export const Skills = () => {
	return (
		<section id="skills" className="px-6 md:px-20 py-20 bg-bg text-text">
						...
						<div className="flex items-center gap-4 mb-4">
							...
							<div>
								...
								<p className="text-xs uppercase tracking-wider text-text/60">
									{skill.level >= 90 ? "Advanced" : skill.level >= 70 ? "Intermediate" : "Beginner"}
								</p>
							</div>
						</div>
